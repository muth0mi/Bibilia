...
public class ActivityBooksBindingImpl extends ActivityBooksBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1},
            new int[] {com.ryanada.bibiliatakatifu.R.layout.activity_books_appbar});
    ...
    private ActivityBooksBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.ryanada.bibiliatakatifu.databinding.ActivityBooksAppbarBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeInclude((com.ryanada.bibiliatakatifu.databinding.ActivityBooksAppbarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeInclude(com.ryanada.bibiliatakatifu.databinding.ActivityBooksAppbarBinding Include, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
