...
public class RowBookBindingImpl extends RowBookBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.book == variableId) {
            setBook((io.muth0mi.bibilia.objects.Book) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setBook(@Nullable io.muth0mi.bibilia.objects.Book Book) {
        this.mBook = Book;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        io.muth0mi.bibilia.objects.Book book = mBook;
