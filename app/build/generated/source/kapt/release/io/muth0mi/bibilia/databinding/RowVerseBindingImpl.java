...
public class RowVerseBindingImpl extends RowVerseBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.verse == variableId) {
            setVerse((io.muth0mi.bibilia.objects.Verse) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVerse(@Nullable io.muth0mi.bibilia.objects.Verse Verse) {
        this.mVerse = Verse;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        io.muth0mi.bibilia.objects.Verse verse = mVerse;
