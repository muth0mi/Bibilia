...
import io.muth0mi.bibilia.databinding.ActivityBooksAppbarBindingImpl;
import io.muth0mi.bibilia.databinding.ActivityBooksBindingImpl;
import io.muth0mi.bibilia.databinding.ActivityVersesBindingImpl;
import io.muth0mi.bibilia.databinding.FragmentTestamentBindingImpl;
import io.muth0mi.bibilia.databinding.RowBookBindingImpl;
import io.muth0mi.bibilia.databinding.RowChapterBindingImpl;
import io.muth0mi.bibilia.databinding.RowVerseBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(io.muth0mi.bibilia.R.layout.activity_books, LAYOUT_ACTIVITYBOOKS);
    INTERNAL_LAYOUT_ID_LOOKUP.put(io.muth0mi.bibilia.R.layout.activity_books_appbar, LAYOUT_ACTIVITYBOOKSAPPBAR);
    INTERNAL_LAYOUT_ID_LOOKUP.put(io.muth0mi.bibilia.R.layout.activity_verses, LAYOUT_ACTIVITYVERSES);
    INTERNAL_LAYOUT_ID_LOOKUP.put(io.muth0mi.bibilia.R.layout.fragment_testament, LAYOUT_FRAGMENTTESTAMENT);
    INTERNAL_LAYOUT_ID_LOOKUP.put(io.muth0mi.bibilia.R.layout.row_book, LAYOUT_ROWBOOK);
    INTERNAL_LAYOUT_ID_LOOKUP.put(io.muth0mi.bibilia.R.layout.row_chapter, LAYOUT_ROWCHAPTER);
    INTERNAL_LAYOUT_ID_LOOKUP.put(io.muth0mi.bibilia.R.layout.row_verse, LAYOUT_ROWVERSE);
  }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      sKeys.put("layout/activity_books_0", io.muth0mi.bibilia.R.layout.activity_books);
      sKeys.put("layout/activity_books_appbar_0", io.muth0mi.bibilia.R.layout.activity_books_appbar);
      sKeys.put("layout/activity_verses_0", io.muth0mi.bibilia.R.layout.activity_verses);
      sKeys.put("layout/fragment_testament_0", io.muth0mi.bibilia.R.layout.fragment_testament);
      sKeys.put("layout/row_book_0", io.muth0mi.bibilia.R.layout.row_book);
      sKeys.put("layout/row_chapter_0", io.muth0mi.bibilia.R.layout.row_chapter);
      sKeys.put("layout/row_verse_0", io.muth0mi.bibilia.R.layout.row_verse);
    }
  }
}
