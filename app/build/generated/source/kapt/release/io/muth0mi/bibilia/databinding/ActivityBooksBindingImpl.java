...
public class ActivityBooksBindingImpl extends ActivityBooksBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {1},
            new int[] {io.muth0mi.bibilia.R.layout.activity_books_appbar});
    ...
    private ActivityBooksBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (io.muth0mi.bibilia.databinding.ActivityBooksAppbarBinding) bindings[1]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeInclude((io.muth0mi.bibilia.databinding.ActivityBooksAppbarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeInclude(io.muth0mi.bibilia.databinding.ActivityBooksAppbarBinding Include, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
